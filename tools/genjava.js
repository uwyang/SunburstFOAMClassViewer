...
//require('../node_modules/sefoam2/node_modules/foam2/src/foam.js');
require('../build/foam-java-bin.js');
require('../build/sefoam-java-bin.js');
require('../build/sesad-java-bin.js');

var classes = [
    "com.serviceecho.workorder.schedule.Preference",
    "com.serviceecho.workorder.schedule.Configuration",
];
...
function loadClass(c) {
  if ( ! foam.lookup(c, true) ) require('../src/main/js/' + c.replace(/\./g, '/') + '.js');
